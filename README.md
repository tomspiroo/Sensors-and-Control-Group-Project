...
testing and colaborative files that eventually make up the Main.m file, 
thus this file will be heavily commented onand of the files that are 
within this will not have detailed comments throughout.
When running the Main.m file make sure all the files present in the Github
...
put together in the Edge_Detection_v2.m file and the Main.m file.
